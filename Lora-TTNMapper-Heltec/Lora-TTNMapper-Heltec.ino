...
-----------------------------------------------------------------------------------------------------------
 ...
 Default is GPIO 2 Tx and GPIO 17 Rx (Closest to "end" of board), speed 9600 Baud. Use 3V3 or Vext for GPS power
...
/* GPS Rx pin */
#define GPS_RX 17 // connect to TX on GPS
/* GPS Tx pin */  
#define GPS_TX 2 // connect to RX on GPS 
/* GPS baud rate */
#define GPS_BAUD 9600

/* GPS coordinates of mapped gateway for calculating the distance */
const double HOME_LAT = -35.201602;
const double HOME_LNG = 149.317677;
